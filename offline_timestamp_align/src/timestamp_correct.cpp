...
int main() {
    ...
    //输入输出文件路径
    std::string cam_csv = "/home/slam/offline_timestamp_align_test/cam0_timestamp.csv";
    std::string cam_aligned_csv = "/home/slam/offline_timestamp_align_test/cam0_aligned.csv";
