...
int main() {
    //数据文件路径
    std::string imu_csv_path = "/home/slam/offline_timestamp_align_test/imu0_data_w_norm.csv";
    std::string vis_csv_path = "/home/slam/offline_timestamp_align_test/visual_angular_velocity_mid_cpp.csv";
